...
- **Scoped AI agent delegation.** Authorize an agent wallet to trade on your behalf with explicit limits — max leverage, allowed markets, and an expiry timestamp. Policy violations are rejected on-chain. Pairs with [Mikey AI policy controls](/docs/changelog/2026-05-30).
