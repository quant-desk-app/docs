---
title: "Changelog: Epics 12–16 — backtesting, markets, data plane, X stream"
sidebarTitle: "Jun 26, 2026"
description: "Shipped quant backtesting, flex proof, unified market registry with US500/US100 pilots, authoritative data plane, and dedicated X stream service."
---
...
- Pro **`BT`** window and Lite backtesting tab use the real job APIs.
...
- **Market Data Ingestion Pipeline** and **Sentiment Feed Aggregator**, hub tables, `/api/v2/market-stats`, `/api/v2/candles`, `/api/v2/data-health`.
- Production UI paths no longer use random/mock volume for market stats.
- [Data plane overview](../data/overview).

## X stream (Epic 16)

- **Social Stream Ingestion Matrix** — `GET /api/v2/x/feed`, alerts, and an agent context tool.
