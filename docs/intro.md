---
title: "QuantDesk documentation home and navigation"
description: "Entry point for QuantDesk docs covering product overview, trading guides, developer integration, security, and FAQ pathways for traders and builders."
---
...
- [Uniques and roadmap](./overview/uniques-and-roadmap) — shipped vs prototype vs roadmap  
- [Why QuantDesk](./overview/why-quantdesk) — values in short form  

### 2 — Guides (typical docs)

**Step-by-step usage for traders and operators.**
